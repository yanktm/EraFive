...
layout = html.Div([
    html.Div([
        ...
        ], style={"border": "1px solid red", "width": "20%", "height": "100vh", "display": "inline-block", "verticalAlign": "top", "boxSizing": "border-box", "padding": "10px", "overflowY": "auto"}),
        
        html.Div([
            dcc.Store(id='stored-images1'),
            html.Img(id='graph1-plot', style={'width': '100%', 'height': 'auto'}),
        ], style={"border": "1px solid green", "width": "40%", "height": "70vh", "display": "inline-block", "verticalAlign": "top", "boxSizing": "border-box"}),
